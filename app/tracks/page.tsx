...
import { Search, Heart, MoreHorizontal, Download, Play } from "lucide-react"

export default function TracksPage() {
  return (
    <div className="min-h-screen bg-[#1a1523] text-white flex flex-col">
      {/* Header */}
      <header className="bg-[#2d1e2f] py-6">
            ...
            <div className="mb-6 md:mb-0">
              <Link href="/" className="flex items-center gap-2">
                <div className="w-6 h-6 bg-gradient-to-r from-green-400 to-purple-500 rounded-md flex items-center justify-center">
                  <div className="w-4 h-4 bg-[#2d1e2f] rounded-md flex items-center justify-center">
      ...
      <main className="flex-1 container mx-auto px-4 md:px-6 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 mb-8">
          <TrackCard title="Your Uploaded Track" artist="You" color="bg-purple-600" isNew={true} />
        </div>
...
function TrackCard({
  ...
  color,
  isNew = false,
}: { title: string; artist: string; color: string; isNew?: boolean }) {
  return (
    <div
